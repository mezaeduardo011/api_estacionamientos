<?php
  ...
  //use Catatumbo\Core\Load\Configuration;
  use Catatumbo\Core\Commun\Constant;
  ...
  trait GenerateConexion
  {
      ...
      private function constructConfigDataBase()
      {
          ...
          $file = Constant::DIR_CONFIG.'databases.ini';
          if (file_exists($file)) {
              ...
              fputs($ar, 'namespace Catatumbo\Complements\Database;'.PHP_EOL);
              fputs($ar, '/**'. PHP_EOL);
